    ...
    if (index != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          duration: const Duration(seconds: 4), // Lama dikit biar sempet mencet
          // 🔥 TOMBOL KEMBALI DI UJUNG KANAN
          action: SnackBarAction(
            label: 'Kembali',
            textColor: Colors.white,
            backgroundColor: Colors.white.withValues(alpha: 0.2),
            onPressed: () {
              // 🔥 NAVIGASI BALIK DENGAN MEMBAWA NOMOR PARAGRAF
              // "Bang, anterin balik ke Mula, terus langsung scroll ke nomor ini ya!"
              _navigateTafsirInternal(
                widget.uid,
                TafsirType.mul,
                targetParamNum: num, // <--- Kirim nomor '115'-nya ke sini
              );
            },
          ),
        ),
                    ...
                    style: {
                      "body": Style(
                        ...
                        padding: HtmlPaddings
                            .zero, // 👈 TAMBAHIN INI JUGA BIAR BERSIH
                        color: textColor,
                      ),
                      ".add": Style(
                        fontStyle: FontStyle.italic,
                          ...
                          return Positioned(
                            ...
                            child: Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () => _showTafsirSwitcherDialog(paraNum),
                                borderRadius: BorderRadius.circular(12),
                                child: Container(
                                  padding: const EdgeInsets.symmetric(
                                    horizontal: 12,
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        fontWeight:
                                            ...
                                            ? FontWeight.bold
                                            : FontWeight.normal,
                                        color: currentType == TafsirType.mul
                                            ? Theme.of(
                                                context,
                                              ).colorScheme.primary
                                            : Colors.grey,
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        fontWeight:
                                            ...
                                            ? FontWeight.bold
                                            : FontWeight.normal,
                                        color: currentType == TafsirType.att
                                            ? Theme.of(
                                                context,
                                              ).colorScheme.primary
                                            : Colors.grey,
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                          ...
                                          fontWeight:
                                              ...
                                              ? FontWeight.bold
                                              : FontWeight.normal,
                                          color: currentType == TafsirType.tik
                                              ? Theme.of(
                                                  context,
                                                ).colorScheme.primary
                                              : Colors.grey,
